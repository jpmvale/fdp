...
| RNF-021 | O dump do Postgres **DEVE** ter cópia fora da máquina. Falha no envio não derruba o backup local, mas sai com erro para o alerta | Manual + `enviar-para-r2.ts` confere o tamanho do objeto |
